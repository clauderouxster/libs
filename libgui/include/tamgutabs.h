...
class Tamgutabs;
//This typedef defines a type "tabsMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgutabs::*tabsMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamgutabs : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<tabsMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamgutabs(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgutabs* a=new Tamgutabs(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, tabsMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodCurrent(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
