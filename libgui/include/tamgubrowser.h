...
#ifndef tamgubrowser_h
#define tamgubrowser_h
#include "tamguwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Tamgubrowser;
//This typedef defines a type "browserMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgubrowser::*browserMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamgubrowser : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<browserMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamgubrowser(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgubrowser* a = new Tamgubrowser(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, browserMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodDeselect(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
	Tamgu* MethodColumnchar(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
	Tamgu* MethodFormatchar(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
