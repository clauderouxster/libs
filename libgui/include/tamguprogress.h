...
#ifndef tamguprogress_h
#define tamguprogress_h
#include "tamguwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Tamguprogress;
//This typedef defines a type "progressMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamguprogress::*progressMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamguprogress : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<progressMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamguprogress(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamguprogress* a = new Tamguprogress(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, progressMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodMinimum(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
	Tamgu* MethodMaximum(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
