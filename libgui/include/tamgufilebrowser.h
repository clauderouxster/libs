...
#ifndef tamgufilebrowser_h
#define tamgufilebrowser_h
#include "tamguwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Tamgufilebrowser;
//This typedef defines a type "filebrowserMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgufilebrowser::*filebrowserMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamgufilebrowser : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<filebrowserMethod> methods;
	...
	char txt[1024];
    //---------------------------------------------------------------------------------------------------------------------
	Tamgufilebrowser(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    short Type() {
        return Tamgufilebrowser::idtype;
    }
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgufilebrowser* a = new Tamgufilebrowser(globalTamgu);
		a->function = f;
		return a;
	}
    ...
    static void AddMethod(TamguGlobal* g, string name, filebrowserMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodOk(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
