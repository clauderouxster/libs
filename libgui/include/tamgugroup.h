...
class Tamgugroup;
//This typedef defines a type "groupMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgugroup::*groupMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------
class Tamgugroup;

class Tamgu_Group : public Fl_Group {
public:
	Tamgugroup* associate;
	int iassociate;
	TamguGlobal* global;

	Tamgu_Group(Tamgugroup* kg, int x, int y, int w, int h, const char* txt);
	~Tamgu_Group();

	void draw();
};

class Tamgugroup : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<groupMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamgugroup(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgugroup* a = new Tamgugroup(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, groupMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodActivate(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
