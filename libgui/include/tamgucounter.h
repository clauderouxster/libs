...
#ifndef tamgucounter_h
#define tamgucounter_h

#include "tamguwidget.h"
//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Tamgucounter;
//This typedef defines a type "counterMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgucounter::*counterMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamgucounter : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<counterMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamgucounter(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgucounter* a = new Tamgucounter(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, counterMethod func, unsigned long arity, string infos);
	...
	Tamgu* MethodLargeStep(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
	Tamgu* MethodSteps(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
	...
	Tamgu* MethodTextColor(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);
