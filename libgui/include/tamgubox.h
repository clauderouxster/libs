...
class Tamgubox;
//This typedef defines a type "boxMethod", which expose the typical parameters of a new Tamgu method implementation
typedef Tamgu* (Tamgubox::*boxMethod)(Tamgu* contextualpattern, short idthread, TamguCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Tamgubox : public Tamguwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static basebin_hash<boxMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Tamgubox(TamguGlobal* g, Tamgu* parent = NULL) : Tamguwidget(g, parent) {
    ...
    Tamgu* Newinstance(short, Tamgu* f = NULL) {
		Tamgubox* a=new Tamgubox(globalTamgu);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(TamguGlobal* g, string name, boxMethod func, unsigned long arity, string infos);
