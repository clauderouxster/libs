...
hmap<string, string> Tamgufilebrowser::infomethods;
basebin_hash<unsigned long> Tamgufilebrowser::exported;
...
bool Tamgufilebrowser::InitialisationModule(TamguGlobal* global, string version) {
	...
	global->RecordMethods(Tamgufilebrowser::idtype, Tamgufilebrowser::exported);
