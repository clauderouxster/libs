...
hmap<string, string> Tamguwoutput::infomethods;
basebin_hash<unsigned long> Tamguwoutput::exported;
...
bool Tamguwoutput::InitialisationModule(TamguGlobal* global, string version) {
	...
	global->RecordMethods(Tamguwoutput::idtype, Tamguwoutput::exported);
