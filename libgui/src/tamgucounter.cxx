...
hmap<string, string> Tamgucounter::infomethods;
basebin_hash<unsigned long> Tamgucounter::exported;
...
bool Tamgucounter::InitialisationModule(TamguGlobal* global, string version) {
	...
	Tamgucounter::idtype = global->Getid("counter");
	...
	global->RecordMethods(Tamgucounter::idtype,Tamgucounter::exported);
