...
hmap<string, string> Tamguprogress::infomethods;
basebin_hash<unsigned long> Tamguprogress::exported;
...
bool Tamguprogress::InitialisationModule(TamguGlobal* global, string version) {
	...
	global->RecordMethods(Tamguprogress::idtype,Tamguprogress::exported);
