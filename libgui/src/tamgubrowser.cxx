...
hmap<string, string> Tamgubrowser::infomethods;
basebin_hash<unsigned long> Tamgubrowser::exported;
...
bool Tamgubrowser::InitialisationModule(TamguGlobal* global, string version) {
	...
	global->RecordMethods(Tamgubrowser::idtype,Tamgubrowser::exported);
